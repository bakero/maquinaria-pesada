...
def fake_repo(tmp_path, monkeypatch):
    ...
    lines = [
        ...
        f"{today}T08:00:05 [INFO ] run=aaa111 script=lanzar_produccion.py pid=10001 | AI call → generate_block model=claude-sonnet-4-6 purpose=generate_block",
        f"{today}T08:00:18 [OK   ] run=aaa111 script=lanzar_produccion.py pid=10001 | AI call ok → generate_block model=claude-sonnet-4-6 ms=13200 tokens_in=1500 tokens_out=800",
