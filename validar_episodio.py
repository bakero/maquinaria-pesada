#!/usr/bin/env python3
"""CLI de validación de guiones — único validador activo.

Ejecuta los 54+ checks de `validators/{base,m,t,s}_validator.py` más la
capa editorial v6.1 (blacklists, expansión castellana de siglas) sobre
un guion M, T o S. Ver `GENERACION.md` §5.

Uso:
    python validar_episodio.py --kind M --ep M3 --guion Guiones/M3.txt
    python validar_episodio.py --kind T --ep M3_T2 --guion ...
    python validar_episodio.py --kind S --ep S1_RAG --guion ... \\
