...
- Alternar el hook por paridad: impares Yago, pares Maria.
...
|---|---|---|---|
| HOOK | Por paridad | El otro | Impares Yago, pares Maria |
...
| CIERRE_CONCEPTOS | Por paridad | El otro | 3 conceptos, cierre alternado |
...
episodio se rechaza en QA y se regenera.
...
- **Conteo de palabras por bloque y speaker:**
  - En bloque liderado por Yago: mínimo 65% palabras del bloque son Yago.
  - En bloque liderado por Maria: mínimo 65% palabras del bloque son Maria.
  - En BLOQUE_COMO compartido: 40-60% para cada uno globalmente.
...
- Apertura por paridad: impares Yago, pares Maria.
---
## 6. Aviso de generación por IA
**Dentro de SALUDO_Y_PRESENTACION**, justo después de la presentación de
nombres. Lo dice quien abre el episodio según paridad.
...
**Reglas:**
- Obligatorio en todos los episodios T sin excepción.
...
El generador construye cada guion T a partir de fuentes con jerarquía
y regla de uso definida.
**Fuente primaria (obligatoria):**
- PDF del tema en `PDFs/temas/M{n}_T{x}_*.pdf`.
- Cubre el 100% del contenido conceptual.
...
1. `PDFs/auxiliares/glosario_unificado.md`
   ...
   - Regla dura: cualquier término técnico que aparezca en el guion Y
     ...
     Si el guion amplía la definición, lo hace sin contradecir.
...
- Lista **3 conceptos máximo** (en T, no 5; el T es corto).
